...
@Ignore
public class GenericContainerWithPortMappingFix<T extends GenericContainer<T>> extends GenericContainer<T> {
	...
	public static Integer getMappedPort(DockerClient dockerClient, GenericContainer<?> genericContainer, int originalPort) {
	...
	private static Integer getMappedPortFromContainer(DockerClient dockerClient, GenericContainer<?> genericContainer, int originalPort) {
	...
	private static Ports.Binding[] getBindings(DockerClient dockerClient, GenericContainer<?> genericContainer, int originalPort) {
		String containerId = genericContainer.getContainerId();
