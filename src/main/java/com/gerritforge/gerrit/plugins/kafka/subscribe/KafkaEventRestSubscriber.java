...
public class KafkaEventRestSubscriber implements KafkaEventSubscriber {
  ...
  /* (non-Javadoc)
   * @see com.gerritforge.gerrit.plugins.kafka.subscribe.KafkaEventSubscriber#subscribe(AckAwareConsumer)
   */
  @Override
  ...
  public void setMessageListener(BrokerApiMessageListener messageListener) {
    logger.atWarning().log("Message listeners are not supported: ignoring it");
  }
}
