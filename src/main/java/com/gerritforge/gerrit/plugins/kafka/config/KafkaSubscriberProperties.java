...
public class KafkaSubscriberProperties extends KafkaProperties {
  ...
  public KafkaSubscriberProperties(
    ...
    warnIfManualAckIsConfiguredWithRestClient();
  }
  ...
  private void warnIfManualAckIsConfiguredWithRestClient() {
    if (getClientType() == ClientType.REST && !autoCommitEnabled) {
      logger.atWarning().log(
          "plugin.events-kafka.enableAutoCommit=false is ignored when clientType=REST; "
