...
public class KafkaEventNativeSubscriber implements KafkaEventSubscriber {
  ...
  /* (non-Javadoc)
   * @see subscribe.plugins.events-kafka.src.main.java.com.gerritforge.gerrit.plugins.kafka.KafkaEventSubscriber#subscribe(java.lang.String, java.util.function.Consumer)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see subscribe.plugins.events-kafka.src.main.java.com.gerritforge.gerrit.plugins.kafka.KafkaEventSubscriber#shutdown()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see subscribe.plugins.events-kafka.src.main.java.com.gerritforge.gerrit.plugins.kafka.KafkaEventSubscriber#getMessageProcessor()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see subscribe.plugins.events-kafka.src.main.java.com.gerritforge.gerrit.plugins.kafka.KafkaEventSubscriber#getTopic()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see subscribe.plugins.events-kafka.src.main.java.com.gerritforge.gerrit.plugins.kafka.KafkaEventSubscriber#resetOffset()
   */
  @Override
